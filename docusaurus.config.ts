    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/jeekeagle/my-book/edit/main/',
          routeBasePath: '/',
        },
        blog: false,
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {href: 'https://github.com/jeekeagle/my-book', label: 'GitHub', position: 'right'},
      ],
    },
    footer: {
      style: 'dark',
      links: [
        ...
        },
        {
          title: '更多',
          items: [
            {label: 'GitHub 仓库', href: 'https://github.com/jeekeagle/my-book'},
